    ...
    class PaymentConfigure : IEntityTypeConfiguration<Payment>
    {
        public void Configure(EntityTypeBuilder<Payment> builder)
        {
            ...
            builder.HasData(
                ...
                new { Id = Guid.Parse("5efb4e85-c71e-4c68-ad5e-8af4cd2148f8"), OrderId = Guid.Parse("a3de7602-4018-4718-90a9-e7d0a299f315"), DateCreate = DateTime.Parse("23.04.2020"), DatePayment = DateTime.Parse("24.05.2020"), Status = PaymentStatus.Paid, Amount = 212.00M },
                new { Id = Guid.Parse("62a2d8b3-144b-49b8-8285-2c07e1d52456"), OrderId = Guid.Parse("5f98d03e-b6dc-41a7-9f3d-86fdda264f26"), DateCreate = DateTime.Parse("13.08.2020"), DatePayment = DateTime.Parse("24.08.2020"), Status = PaymentStatus.Paid, Amount = 550.00M }
            );
        }
    }
}
