    ...
    class PainterConfigure : IEntityTypeConfiguration<Painter>
    {
        public void Configure(EntityTypeBuilder<Painter> builder)
        {
            ...
            builder.HasData(
                ...
                new { Id = Guid.Parse("549903f5-66ab-48e8-b126-8610c4bb08b9"), Name = "Рембрандт Харменс ван Рейн", StyleId = Guid.Parse("6801a5c4-fc35-468d-884f-75af47a288d6"), Age = (byte)63, Description = "Рембрандт изображал мир таким, какой он был. Без прикрас и лакировок. Но получалось у него это очень душевно." },
